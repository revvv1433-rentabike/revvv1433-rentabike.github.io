        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/" className="text-gray-400 hover:text-yellow-400 transition">Home</Link>
              </li>
              <li>
                <Link to="/Fleet" className="text-gray-400 hover:text-yellow-400 transition">Our Fleet</Link>
              </li>
              <li>
                <Link to="/AboutUs" className="text-gray-400 hover:text-yellow-400 transition">About Us</Link>
              </li>
              <li>
                <Link to="/Contact" className="text-gray-400 hover:text-yellow-400 transition">Contact</Link>
              </li>
              <li>
                <Link to="/TemplesNearby" className="text-gray-400 hover:text-yellow-400 transition">Temples Nearby</Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-400">
                  Tirupathi Bike Rentals, Near Railway Station, Tirupati, Andhra Pradesh
                </span>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={18} className="text-yellow-400 flex-shrink-0" />
                <a href="tel:+919393936773" className="text-gray-400 hover:text-yellow-400 transition">
                  +91 9393936773
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail size={18} className="text-yellow-400 flex-shrink-0" />
                <a href="mailto:revvv143@gmail.com" className="text-gray-400 hover:text-yellow-400 transition">
                  revvv143@gmail.com
                </a>
              </li>
            </ul>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-yellow-400 hover:text-gray-900 transition"
                >
                  <Facebook size={18} />
                </a>
                <a
                  href="https://www.instagram.com/revvv143?igsh=bTZqZWVsaG1oaGlm"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-yellow-400 hover:text-gray-900 transition"
                >
